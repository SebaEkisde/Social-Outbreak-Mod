...
public class EntityChalecoamarillomob extends ElementsSocialOutbreakModMod.ModElement {
	public static final int ENTITYID = 6;
	public static final int ENTITYID_RANGED = 7;
	public EntityChalecoamarillomob(ElementsSocialOutbreakModMod instance) {
		super(instance, 24);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("social_outbreak_mod", "chalecoamarillomob"), ENTITYID).name("chalecoamarillomob").tracker(67, 3, true)
				.egg(-3355648, -1).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(9, new EntityAINearestAttackableTarget(this, EntityPlayerMP.class, false, false));
			this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, EntityPlayer.class, false, false));
		}
